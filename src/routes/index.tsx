      ...
      <div className="w-full max-w-[615px]">
        <div className="rounded-[2.5rem] border border-border bg-card px-10 py-20 shadow-xl shadow-primary/10">
          ...
          <div className="mt-12 grid gap-4">
            ...
            <button
              onClick={redirect}
              className="inline-flex items-center justify-center rounded-full border border-border bg-secondary px-6 py-4 text-base font-medium text-secondary-foreground transition-colors hover:bg-accent"
            >
              No thanks
            </button>
          </div>
